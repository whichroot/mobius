...
// Module: Mobius.StructureLemma
// Imports: public import Init public meta import Init public import Mobius.Basic public import Mathlib.Algebra.Ring.GeomSum public import Mathlib.Data.Int.GCD public import Mathlib.Tactic.LinearCombination public import Mathlib.Tactic.GCongr
#include <lean/lean.h>
...
lean_object* initialize_Init(uint8_t builtin);
lean_object* initialize_Mobius_Mobius_Basic(uint8_t builtin);
...
LEAN_EXPORT lean_object* initialize_Mobius_Mobius_StructureLemma(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mobius_Mobius_Basic(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
